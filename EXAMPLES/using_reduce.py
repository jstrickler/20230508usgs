...
# sum()
result = reduce(add, values) # add values in list (initial value defaults to first item)
...
# product
result = reduce(mul, values)  # multiply all values together (initial value is 10, otherwise product would be 0)
print("result is", result)
